...
behavior--realization separation, not a universal behavior runtime or
...
primal/dual solution --- previously unused anywhere in this codebase,
and off by default so no other reported number is affected by its
existence --- cuts the admittance mean solve time by 47\% (11.7~ms to
