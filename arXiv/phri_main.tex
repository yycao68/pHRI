...
operational-space feedforward cancellation exposes a linear double-integrator
backbone with configuration dependence confined to $B_d(\rho_k)$, turning
...
configuration-independent---is exponentially stable across the whole workspace
under a single Lyapunov certificate (Theorem~\ref{thm:workspace}). On a Franka
