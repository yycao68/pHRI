...
stricter actuation budget than a response-matched impedance baseline, using
...
at 378\,W and 0.45\% saturated samples for a response-matched impedance
...
and a scalar damping ratio on the calibration cycle; it is not a full
frequency-response match, and ``response-matched'' below refers to this
stiffness- and damping-calibrated baseline rather than a guarantee of
matched rise time, overshoot, or multiaxis coupling. A torque-aware PI
