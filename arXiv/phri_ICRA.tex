...
tested moving task without increasing peak power. Results are simulation-only
and establish a compact realization and controlled ablation, not a hardware
safety or universal performance claim.
\end{abstract}
