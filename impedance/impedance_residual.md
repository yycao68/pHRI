...
| Periodic-only (as tested, Sections 6-7; small pulse present) | **20.409 ± 1.679** | 20.737 ± 1.628 | +0.328 | [0.220, 0.436] | \(4.24\times10^{-6}\) |
| Pulse-only\(^\dagger\) (entirely non-harmonic) | **21.212 ± 0.026** | 21.583 ± 0.010 | +0.371 | [0.359, 0.383] | \(8.72\times10^{-24}\) |
| Full matched (satellite; substantial contact content) | 19.133 ± 0.634 | **18.773 ± 0.457** | -0.360 | [-0.541, -0.179] | \(5.23\times10^{-4}\) |
